...
class PAPPElectionBuilder:
    ...
    parties: list[int] #parties are represented as numbers from 0 to m-1
    voters: list[int] #voters are represented as numbers from 0 to n-1
    ...
    #Computes the set of approval ballots without the ballot in which a voter approves all alternatives
    ...
    #computes all P-APP committees for the given parameters
